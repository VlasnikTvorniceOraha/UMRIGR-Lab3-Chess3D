...
namespace ChessMainLoop
{
    public class UIManager : Singleton<UIManager>
    {
        ...
        [SerializeField] private GameObject _randomizeMenu;
        ...
        [SerializeField] private Button _randomizeYesButton;
        [SerializeField] private Button _randomizeNoButton;
        ...
        private void Start()
        {
            ...
            _randomizeYesButton.onClick.AddListener(RandomizeYes);
            _randomizeNoButton.onClick.AddListener(RandomizeNo);
        ...
        public void RandomizeYes()
        {
            _camera.enabled = true;
            _randomizeMenu.SetActive(false);
            //randomiziraj board
            BoardState.Instance.RandomizeBoard();
        }

        public void RandomizeNo()
        {
            _randomizeMenu.SetActive(false);
            _camera.enabled = true;
        }
